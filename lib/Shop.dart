                  ...
                  children: [
                    ...
                    InkWell(
                          ...
                          child: Center(
                              ...
                              Row(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(padding: EdgeInsets.only(right: 5),child:  Text('وارد کردن کد خرید',style: TextStyle(color: purplecolor,fontFamily: 'MyFont',fontSize: 18,fontWeight: FontWeight.bold),),),
                      ...
                      onTap: (){
                        Alert(
                            context: context,
                            title: "کدی که هنگام خرید دریافت کرده اید وارد کنید",
                            content: Column(
                              children: <Widget>[
                                Padding(
                                  child:    TextField(
                                    controller: InputBuyedCode,
                                    textAlign: TextAlign.center,
                                    cursorColor: Colors.deepPurple,
                            ...
                            buttons: [
                              DialogButton(
                                onPressed:(){
                                  if(InputBuyedCode.text == null || InputBuyedCode.text == ''){
                                    Fluttertoast.showToast(
                                        msg: "کد را وارد نمایید.",
                                        toastLength: Toast.LENGTH_SHORT,
                                        gravity: ToastGravity.CENTER,
                                        timeInSecForIosWeb: 1,
                                    ...
                                    InquiryCode(InputBuyedCode.text);
                                  }
