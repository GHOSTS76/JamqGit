    ...
    return WillPopScope(child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            ...
            Padding(padding: EdgeInsets.only(top: 200,left: 15,right: 15,bottom: 15),child: Card(
                  ...
                  children: <Widget>[
                            ...
                            child:Padding(padding: EdgeInsets.only(left: 5),child: new Directionality(textDirection: TextDirection.ltr, child: VerificationCode(
                              ...
                              onCompleted: (String value) {
                                setState(() {
                                  ...
                                  _code = value;
                                  print('---__COde'+_code);
                                  print('wwwwCode'+widget.Code.toString());
                    ...
                    InkWell(
                      ...
                      onTap: (){
                        ...
                        print('CODEEEE'+widget.Code.toString());
                        print('CCCCCCC'+_code);
                        if(widget.Code.toString() == _code){
                          _openLoadingDialog(context);
                          GetUserInfo(widget.Number);
  ...
  GetUserInfo(Number) async {
    ...
    try {
      Response response = await Dio().post("http://jamq.ir:3000/Mainuser/GetUserInfoByPhone",data:formData);
        ...
        print('ALLLLOOO');
        print(UserInfo.GetEmail().toString());
        print(UserInfo.GetFamily().toString());
